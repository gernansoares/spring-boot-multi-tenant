package com.multitenant.example.domain.config.exceptions;

import com.multitenant.example.domain.exceptions.ApiErrors;
import com.multitenant.example.domain.exceptions.InternalException;
